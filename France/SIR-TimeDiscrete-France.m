...
[infected1,infected2] = textread('France-Confirmed.csv','%s;%f','delimiter',';');
...
lt01 = title("France: People vs. Dates (Unprocessed)", "fontsize", 14);
...
lt02 = title("France: People vs. Dates (Processed)", "fontsize", 14);
...
lt03 = title("France: Beta vs. Dates", "fontsize", 14);
xt03 = xlabel("t", "fontsize", 14);
...
hold off
plot(dates, I, 'color', 'black', '-@');
lt02 = title("France: Infected vs. Dates", "fontsize", 14);
xt02 = xlabel("t", "fontsize", 14);
...
lt02 = title("France: Recovered vs. Dates", "fontsize", 14);
xt02 = xlabel("t", "fontsize", 14);
